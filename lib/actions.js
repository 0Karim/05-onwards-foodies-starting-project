...
export async function shareMeal(prevState, formData) {
    ...
    await saveMeal(meal);
    revalidatePath('/meals');// This will trigger a revalidation of the /meals page, ensuring that the new meal appears in the list without needing to refresh the entire page.
    redirect('/meals');
}